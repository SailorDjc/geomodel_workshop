...
from geodata_process_1 import GeoMeshGraphParse
import time
...
class GmeModelGraphList(object):
    ...
    def update_graph_log(self, model_name=None, save_idx=0, dims=None, node_feat=None,
                         edge_feat=None, **kwargs):
        ...
        self.graph_log['graph'][save_idx][dims] = dims
        self.graph_log['graph'][save_idx][node_feat] = node_feat
        self.graph_log['graph'][save_idx][edge_feat] = edge_feat
